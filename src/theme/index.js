export default {
  ...
  colors: {
    text: "#2C3E50", // body color and primary color
    ...
    primary: "#8BC34A", // primary button and link color
    secondary: "#7FB3D5", // secondary color - can be used for hover states
    muted: "#7B8188", // muted color
    accent: "#D1F2EB", // a contrast color for emphasizing UI
    dark: "#10132D",
